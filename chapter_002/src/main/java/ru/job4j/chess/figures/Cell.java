...
/**
 * Cell - enumeration which describes the chess board cell.
 *
...
public enum Cell {
    ...
    /** x coordinate of cell (x increase from left to right, range[0..7]) */
    public final int x;
    /** y coordinate of cell (y increase from top to bottom, range[0..7])*/
    public final int y;
    ...
    /**
     * Get method for the ordinal value of Cell element.
     * @param x - x coordinate.
     * @param y - y coordinate.
     * @return - ordinal number (range [0..63]).
     */
